...
function SmallCartDiv() {
  ...
  const handleDeleteFromCart = (idProduct) => {
    dispatch(deleteFromCart(idProduct));
  };
      ...
      {product.length === 0 ? (
        ...
        <div className="products-in-cart">
          {product.map((cartProduct, i) => {
            const numberItemsArray = () => cartProduct.numberItems.split(`,`);
            ...
            return (
              <div key={i} className="one-product-in-cart">
                ...
                <button
                  ...
                  onClick={() => handleDeleteFromCart(cartProduct.idProduct)}
                >
...
/*
            const number = () => {
              Array.from(cartProduct.numberItems).reduce(
